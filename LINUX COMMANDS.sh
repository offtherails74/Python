...
cp -r source destination 	            Copy source recursively to destination. If a destination exists, copy the source directory into the destination. Otherwise, create a destination with the contents of the source directory.
mv file1 file2 	                        Rename or move file1 to file2. If file2 is an existing directory, move file1 into directory file2
ln -s /path/to/file linkname 	        Create a symbolic link to the link name (shortcut)
...
FILE PERMISSIONS - Linux chmod Example
